...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="Parawisata.php">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Parawisata</h1>
                        <a href="addparawisata.php" class="btn btn-sm btn-primary shadow-sm">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($parawisata as $row) : ?>
                                            <tr>
                                                ...
                                                <th><?= $row["gambar"]; ?></th>
                                                <th>
                                                    <a class="badge badge-primary" href="updateparawisata.php?id=<?= $row["id"]; ?>">Ubah</a>
                                                    <a class="badge badge-danger" href="hapusparawisata.php?id=<?= $row["id"]; ?>">Hapus</a>
                                                </th>
                                            </tr>
                                            <?php $i++; ?>
                                        <?php endforeach; ?>
