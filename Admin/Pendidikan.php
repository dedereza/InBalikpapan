...
$jumlahData = count(query("SELECT * FROM pendidikan")); //8


if (isset($_GET["cari"])) {
    $keyword = $_GET["keyword"];
    $pendidikan = caripendidikan($_GET["keyword"]);
    $jumlahData = count($pendidikan);
}
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Layanan Pendidikan</h1>
                        <a href="addpendidikan.php" class="btn btn-sm btn-primary shadow-sm">
                            <i class="fas fa-plus fa-sm text-white-80">Tambah Data</i>
                        </a>
                    </div>
                    <div class="row">
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($pendidikan as $row) : ?>
                                            <tr>
                                                ...
                                                <th><?= $row["nama"]; ?></th>
                                                <th><?= $row["alamat"]; ?></th>
                                                <th><?= substr_replace($row["rangkuman"], "...", 50); ?></th>
                                                <th><?= substr_replace($row["deskripsi"], "...", 50); ?></th>
                                                <th><?= $row["gambar"]; ?></th>
                                                <th>
                                                    <a class="badge badge-primary" href="updatependidikan.php?id=<?= $row["id"]; ?>">Ubah</a>
                                                    <a class="badge badge-danger" href="hapuspendidikan.php?id=<?= $row["id"]; ?>">Hapus</a>
                                                </th>
                                            </tr>
                                            <?php $i++; ?>
                                        <?php endforeach; ?>
                ...
                <ul class="pagination justify-content-center">
                    ...
                    <?php else : ?>
                        ...
                        <?php for ($i = 1; $i <= $jumlahHalaman; $i++) : ?>
                            <?php if ($i == $halamanAktif) : ?>
                                <li class="page-item">
                                    <a class="page-link" href="pendidikan.php?keyword=<?= $_COOKIE["keyword"]; ?>&cari=&halaman=<?= $i; ?>"><?= $i; ?></a>
                                </li>
                            <?php else : ?>
                                <li class="page-item">
                                    <a class="page-link" href="pendidikan.php?keyword=<?= $_COOKIE["keyword"]; ?>&cari=&halaman=<?= $i; ?>"><?= $i; ?></a>
