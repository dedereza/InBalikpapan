                                ...
                                <div class="user justify-content-between d-flex">
                                    <div class="desc">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div class="reply-btn">
                                                <button href="#" class="btn-reply text-uppercase reply" id="' . $rak["comment_id"] . '">reply</button>
                                            </div>
                                        </div>
                                        <p class="comment">
                                            '. nl2br($rak["comment"]) .'
...
{
    $query = "
 SELECT * FROM commentparawisata WHERE parent_comment_id = '" . $parent_id . "'
 ";
    $output = '';
    $statement = $connect->prepare($query);
    $statement->execute();
