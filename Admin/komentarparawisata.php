...
$jumlahData = count(query("SELECT * FROM commentparawisata")); //8


if (isset($_GET["cari"])) {
    $keyword = $_GET["keyword"];
    $komentarparawisata = carikomentarparawisata($_GET["keyword"]);
    $jumlahData = count($komentarparawisata);
}
...
$query = "SELECT * FROM commentparawisata
                        ...
                        ";
$komentarparawisata = query($query);
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="komentarparawisata.php">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data komentar Parawisata</h1>
                    </div>
                    <div class="row">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php $i = 1 + $awalData; ?>
                                        <?php foreach ($komentarparawisata as $row) : ?>
                                            <tr>
                                                <th><?= $i; ?></th>
                                                ...
                                                <th><?= $row["date"]; ?></th>
                                                <th>
                                                    <a class="badge badge-primary" href="updatekomentarparawisata.php?comment_id=<?= $row["comment_id"]; ?>">Ubah</a>
                                                    <a class="badge badge-danger" href="hapuskomentarparawisata.php?comment_id=<?= $row["comment_id"]; ?>">Hapus</a>
                                                </th>
                                            </tr>
                                            <?php $i++; ?>
                                        <?php endforeach; ?>
                ...
                <ul class="pagination justify-content-center">
                    ...
                    <?php else : ?>
                        ...
                        <?php for ($i = 1; $i <= $jumlahHalaman; $i++) : ?>
                            <?php if ($i == $halamanAktif) : ?>
                                <li class="page-item">
                                    <a class="page-link" href="komentarparawisata.php?keyword=<?= $_COOKIE["keyword"]; ?>&cari=&halaman=<?= $i; ?>"><?= $i; ?></a>
                                </li>
                            <?php else : ?>
                                <li class="page-item">
                                    <a class="page-link" href="komentarparawisata.php?keyword=<?= $_COOKIE["keyword"]; ?>&cari=&halaman=<?= $i; ?>"><?= $i; ?></a>
