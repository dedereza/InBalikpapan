            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="addkesehatan.php" class="btn btn-sm btn-primary shadow-sm">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($kesehatan as $row) : ?>
                                            <tr>
                                                ...
                                                <th><?= $row["gambar"]; ?></th>
                                                <th>
                                                    <a class="badge badge-primary" href="updatekesehatan.php?id=<?= $row["id"]; ?>">Ubah</a>
                                                    <a class="badge badge-danger" href="hapus.php?id=<?= $row["id"]; ?>">Hapus</a>
                                                </th>
                                            </tr>
                                            <?php $i++; ?>
                                        <?php endforeach; ?>
                ...
                <ul class="pagination justify-content-center">
                    ...
                    <?php else : ?>
                        ...
                        <?php for ($i = 1; $i <= $jumlahHalaman; $i++) : ?>
                            <?php if ($i == $halamanAktif) : ?>
                                <li class="page-item">
                                    <a class="page-link" href="kesehatan.php?keyword=<?= $_COOKIE["keyword"]; ?>&cari=&halaman=<?= $i; ?>"><?= $i; ?></a>
                                </li>
                            <?php else : ?>
                                <li class="page-item">
                                    <a class="page-link" href="kesehatan.php?keyword=<?= $_COOKIE["keyword"]; ?>&cari=&halaman=<?= $i; ?>"><?= $i; ?></a>
