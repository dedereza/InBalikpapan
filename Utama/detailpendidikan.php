...
$pwa = query("SELECT * FROM pendidikan WHERE id = $id")[0];
                ...
                <div class="col-lg-12">
                    <div class="breadcrumb_iner">
                        <div class="breadcrumb_iner_item text-center">
                            <h2>Pendidikan</h2>
                            <p><a href="pendidikan.php">Pendidikan</a> . Detail Pendidikan</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-8 posts-list">
                    <div class="single-post">
                        <div class="feature-img">
                            <img class="img-fluid" src="img/Pendidikan/<?= $pwa["gambar"]; ?>" alt="">
                        </div>
