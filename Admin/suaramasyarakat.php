...
$jumlahData = count(query("SELECT * FROM suaramasyarakat")); //8


if (isset($_GET["cari"])) {
    $keyword = $_GET["keyword"];
    $suaramasyarakat = carisuaramasyarakat($_GET["keyword"]);
    $jumlahData = count($suaramasyarakat);
}
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Suara Masyarakat</h1>
                    </div>
                    <div class="row">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php $i = 1 + $awalData; ?>
                                        <?php foreach ($suaramasyarakat as $row) : ?>
                                            <tr>
                                                <th><?= $i; ?></th>
                                                ...
                                                <th><?= $row["date"]; ?></th>
                                                <th>
                                                    <a class="badge badge-primary" href="updatesuaramasyarakat.php?comment_id=<?= $row["comment_id"]; ?>">Ubah</a>
                                                    <a class="badge badge-danger" href="hapussuaramasyarakat.php?comment_id=<?= $row["comment_id"]; ?>">Hapus</a>
                                                </th>
                                            </tr>
                                            <?php $i++; ?>
                                        <?php endforeach; ?>
                ...
                <ul class="pagination justify-content-center">
                    ...
                    <?php else : ?>
                        ...
                        <?php for ($i = 1; $i <= $jumlahHalaman; $i++) : ?>
                            <?php if ($i == $halamanAktif) : ?>
                                <li class="page-item">
                                    <a class="page-link" href="suaramasyarakat.php?keyword=<?= $_COOKIE["keyword"]; ?>&cari=&halaman=<?= $i; ?>"><?= $i; ?></a>
                                </li>
                            <?php else : ?>
                                <li class="page-item">
                                    <a class="page-link" href="suaramasyarakat.php?keyword=<?= $_COOKIE["keyword"]; ?>&cari=&halaman=<?= $i; ?>"><?= $i; ?></a>
