...
$pwa = query("SELECT * FROM kesehatan WHERE id = $id")[0];
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light justify-content-between">
                            ...
                            <div class="collapse navbar-collapse main-menu-item justify-content-center" id="navbarSupportedContent">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="kesehatan.php">Suara Masyarakat</a>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="col-lg-12">
                    <div class="breadcrumb_iner">
                        <div class="breadcrumb_iner_item text-center">
                            <h2>Kesehatan</h2>
                            <p><a href="kesehatan.php">Kesehatan</a> . Detail Kesehatan</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-8 posts-list">
                    <div class="single-post">
                        <div class="feature-img">
                            <img class="img-fluid" src="img/Kesehatan/<?= $pwa["gambar"]; ?>" alt="">
                        </div>
